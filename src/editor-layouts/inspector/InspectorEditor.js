...
export default class InspectorEditor extends BaseLayout {
  ...
  initialize () {
    ...
    this.$editor.registerInspector(this.id, this.createComponentFunction.bind(this));
  }

  createComponentFunction() {
    console.log(this.opt, 'fdskalfjdsk');
    ...
    return /*html*/`
      <div class="easylogic-inspector ${this.state.ua}" data-theme="${this.$editor.theme}">
        <div class="layout-main">
            <object refClass='Inspector' targetInspector="${this.id}" />
        </div>
